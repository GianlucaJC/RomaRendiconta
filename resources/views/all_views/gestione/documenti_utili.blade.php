						...
						@foreach($documenti_utili as $documento)
							<tr>
								...
								<td style="max-width:400px">
									...
									<?php
										if (strlen($documento->url_ref)>0) {
											echo "<hr><a href='".$documento->url_ref."' target='_blank'>";
												echo "Link di riferimento";
											echo "</a>";
...
<div class="modal fade bd-example-modal-lg" id="modalvalue" tabindex="-1" role="dialog" aria-labelledby="title_doc" aria-hidden="true">
 ...
 @section('content_plugin')
	...
	<script src="{{ URL::asset('/') }}dist/js/documenti_utili.js?ver=1.69"></script>
