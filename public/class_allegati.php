...
<div id="sez_allegati" style="" class="mt-2">
	...
	<hr>
	 ...
	 <div class="form-group" style='display:none' id='div_url'>
		<label for="file_user">Link di riferimento</label>
		<input type="text" class="form-control" id="url_ref" name="url_ref" aria-describedby="URL" placeholder="Link di riferimento" >
